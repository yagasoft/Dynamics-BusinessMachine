...
function stageHelper(stage, step) {
...
export function buildGuidedWorkspaceViewModel(snapshot, audience = snapshot.audience) {
    ...
    const actions = isHiddenCurrentStage
        ? []
    ...
    const siblingSteps = isHiddenCurrentStage
        ? []
