...
async function createTempDistRoot() {
    ...
    await fs.writeFile(path.join(distRoot, 'index.html'), '<!doctype html><html><body><div id="dbm-local-proof-root"></div></body></html>', 'utf8');
