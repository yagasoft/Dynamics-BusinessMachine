...
function buildRequestReference(record: DbmPortalRuntimeRecordV1 | null): string | null {
  return record?.requestReference ?? record?.id ?? null;
}

export function buildPortalRuntimeSnapshot(
  bootstrap: DbmPortalRuntimeBootstrapV1,
...
export function buildPortalRuntimeViewModel(options: DbmPortalRuntimeViewModelOptions): DbmPortalRuntimeViewModel {
