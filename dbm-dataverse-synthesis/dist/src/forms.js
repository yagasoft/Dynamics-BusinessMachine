...
function invertChoiceMap(choiceMap) {
    const inverted = {};
    if (!choiceMap) {
        return inverted;
    }
...
function buildFormRuntimePlan(model, form, entityPlans, primaryEntityPlan, diagnostics) {
    ...
    const relatedRequestLookupFieldLogicalName = primaryEntityPlan.id === runtimeOwnerEntityId
        ? null
        : (() => {
    ...
    const reviewEntityLogicalName = model.metadata.entities.find((entry) => entry.id === 'request-decision')?.providerBindings.dataverse?.logicalName?.trim() ?? null;
    const reviewEntityRequestLookupFieldLogicalName = model.metadata.entities
    ...
    const decisionOutcomeFieldLogicalName = (() => {
        const field = reviewMetadataEntity ? (0, common_1.getFieldById)(reviewMetadataEntity, 'decision-outcome') : undefined;
        return field?.providerBindings.dataverse?.logicalName?.trim() ?? null;
    })();
    const decisionSummaryFieldLogicalName = (() => {
        const field = reviewMetadataEntity ? (0, common_1.getFieldById)(reviewMetadataEntity, 'decision-summary') : undefined;
        return field?.providerBindings.dataverse?.logicalName?.trim() ?? null;
    })();
    const decisionCommentFieldLogicalName = (() => {
        const field = reviewMetadataEntity ? (0, common_1.getFieldById)(reviewMetadataEntity, 'decision-comment') : undefined;
        return field?.providerBindings.dataverse?.logicalName?.trim() ?? null;
    })();
    ...
    return {
        ...
        requestEntityPrimaryIdLogicalName: runtimeOwnerMetadataEntity?.fields
