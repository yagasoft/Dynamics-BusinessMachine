...
Assert-Contains 'docs\roadmap\progress-tracker.md' 'R2.1 DBMScript contract and collaborative authoring foundation' 'Roadmap progress tracker must retain the completed R2.1 slice name.'
Assert-Contains 'docs\roadmap\progress-tracker.md' 'R2.1 contract/storage proof is complete' 'Roadmap progress tracker must show that the R2.1 contract/storage proof is complete.'
Assert-Contains 'docs\roadmap\progress-tracker.md' 'contract/schema/fixture and synthesis-plan coverage' 'Roadmap progress tracker must name the R2.1 proof boundary.'
Assert-Contains 'docs\roadmap\progress-tracker.md' 'R2.2 Power Apps Code Apps designer host proof' 'Roadmap progress tracker must name the next planned R2.2 slice.'
Assert-Contains 'docs\roadmap\progress-tracker.md' 'R2.2 is the next planned slice and has not started' 'Roadmap progress tracker must not imply that R2.2 implementation has started.'
