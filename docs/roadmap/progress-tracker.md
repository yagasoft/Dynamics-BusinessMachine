...
- R2 implementation status: Active planning; implementation proof has not started.
...
| Active planning | The next release or slice is being shaped in durable docs, but implementation proof has not landed yet. |
...
| `R2` | DBMScript and action foundation | Active planning | R2 is the active roadmap focus. The current slice is `R2.1 DBMScript contract and collaborative authoring foundation`; implementation proof has not started. | [R2 plan](release-2-dbmscript-and-action-foundation.md), [ADR-0017](../adr/0017-collaborative-authoring-and-code-apps-designer.md) |
...
`R2` is the active release. The next implementation slice is `R2.1 DBMScript contract and collaborative authoring foundation`.
