//         Project / File: Yagasoft.Dbm.Plugins / CrmSchema.cs
...
namespace Yagasoft.Dbm.Plugins
{
	...
	[ExcludeFromCodeCoverage]
	[DebuggerNonUserCode]
	[DataContract, EntityLogicalName("webresource")]
	public partial class WebResource : GeneratedEntity<WebResource.RelationName>
	{
		public WebResource() : base(EntityLogicalName)
		{ }
		
		/// <inheritdoc/>
		public WebResource(string[] keys, object[] values) : base(keys, values, EntityLogicalName)
		{ }
		
		/// <inheritdoc/>
		public WebResource(object obj, Type limitingType) : base(obj, limitingType, EntityLogicalName)
		{ }

		public const string DisplayName = "Web Resource";
		public const string SchemaName = "WebResource";
		...
		{
			get => (WebResourceIdentifierId == null || WebResourceIdentifierId == Guid.Empty) ? base.Id : WebResourceIdentifierId.GetValueOrDefault();
			set
			{
                if (value == Guid.Empty) {
                    Attributes.Remove("webresourceid");
                    base.Id = value;
                } else {
				    WebResourceIdentifierId = value;
                }
			}
		}
		...
		public Guid? WebResourceIdentifierId
		{
			get
			{
				var value = GetAttributeValue<Guid?>("webresourceid");
			    return value;
			}
			set
			{
		...
		/// <inheritdoc/>
		public WebResource(object obj) : base(obj, EntityLogicalName)
		{
